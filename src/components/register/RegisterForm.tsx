    ...
    <div className="min-h-screen pb-20 bg-bg">
      ...
      <div className="relative overflow-hidden border-b border-line">
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-6 pt-12 pb-10 text-center">
          <div className="w-16 h-16 mx-auto rounded-full flex items-center justify-center mb-5 overflow-hidden" style={{ border: "1px solid rgba(212,175,55,0.6)", boxShadow: "0 0 0 4px rgba(212,175,55,0.08)" }}>
